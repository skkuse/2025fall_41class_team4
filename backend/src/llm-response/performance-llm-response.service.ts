...
export class PerformanceLlmResponseService {
    ...
    async generateAnswer(question: string, items: PerformanceData[]) {
        ...
        const sys = `
            ...
            [summary 부분 출력 예시]
            예시1
            "summary": "따뜻하고 감성적인 지브리 음악 콘서트로 인물과 감정선을 깊이 다루어 지브리 팬에게 추천합니다."
            
            예시2
            "summary": "고전 소설을 바탕으로 한 뮤지컬로, 가족 모두가 즐길 수 있는 스크루지의 이야기를 생생하게 전달합니다."
            
            예시3
            "summary": "부산에서 열리는 크리스마스 특별공연으로, 다양한 사연을 통해 따뜻한 연말 분위기를 선사합니다."
            
            예시4
            "summary": "서바이벌 테마의 뮤지컬로, 긴장감 넘치는 스토리와 매력적인 캐릭터들이 돋보이는 공연입니다."
            
            예시5
            "summary": "지브리 음악을 사랑하는 팬들을 위한 특별한 콘서트로, 다양한 날짜 옵션을 제공하여 편리한 관람이 가능합니다."
                `;
